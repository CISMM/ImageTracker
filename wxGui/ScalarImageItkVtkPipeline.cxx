...
ScalarImageItkVtkPipeline::InputImageType::Pointer ScalarImageItkVtkPipeline::GetInput()
{
...
wxWindow* ScalarImageItkVtkPipeline::CreateWxControl(wxWindow* parent)
{
...
void ScalarImageItkVtkPipeline::SetVisibility(int visible)
{
    this->actor->SetVisibility(visible);
    ImageTrackerController::Instance()->Render();
}

int ScalarImageItkVtkPipeline::GetVisibility() const
{
    return this->actor->GetVisibility();
}

void ScalarImageItkVtkPipeline::SetWindowMinimum(const InputPixelType min)
{
...
void ScalarImageItkVtkPipeline::SetWindowMaximum(const InputPixelType max)
{
...
ScalarImageItkVtkPipeline::InputPixelType ScalarImageItkVtkPipeline::GetWindowMinimum() const
{
    return this->window->GetWindowMinimum();
}

ScalarImageItkVtkPipeline::InputPixelType ScalarImageItkVtkPipeline::GetWindowMaximum() const
{
