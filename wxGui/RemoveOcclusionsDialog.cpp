    ...
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER|wxTHICK_FRAME)
{
    ...
    label_1 = new wxStaticText(this, wxID_ANY, wxT("Metric"));
    const wxString comboMetric_choices[] = {
        wxT("Median"),
        wxT("Mean")
    };
    comboMetric = new wxComboBox(this, wxID_ANY, wxT(""), wxDefaultPosition, wxDefaultSize, 2, comboMetric_choices, wxCB_DROPDOWN|wxCB_READONLY);
    label_3 = new wxStaticText(this, wxID_ANY, wxT("Max Transmission"));
    slidePercentile = new wxSlider(this, wxID_ANY, 100, 0, 100, wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL|wxSL_LABELS);
    label_4 = new wxStaticText(this, wxID_ANY, wxT("Fourier Padding"));
    slidePadding = new wxDoubleSlider(this, wxID_ANY);
    panelFilePattern = new FilePatternPanel(this, wxID_ANY);
    label_5 = new wxStaticText(this, wxID_ANY, wxT("Transmission Map"));
    textTransmission = new wxTextCtrl(this, wxID_ANY, wxT("transmission.mha"));
...
void RemoveOcclusionsDialog::do_layout()
{
    ...
    grid_sizer_3->Add(comboMetric, 0, wxEXPAND, 0);
    grid_sizer_3->Add(85, 20, 0, 0, 0);
    grid_sizer_3->Add(label_3, 0, 0, 0);
    grid_sizer_3->Add(slidePercentile, 0, wxEXPAND, 0);
    grid_sizer_3->Add(20, 20, 0, 0, 0);
    grid_sizer_3->Add(label_4, 0, 0, 0);
    grid_sizer_3->Add(slidePadding, 1, wxEXPAND, 0);
    grid_sizer_3->Add(20, 20, 0, 0, 0);
    ...
    grid_sizer_2->Add(textTransmission, 0, wxEXPAND, 0);
    grid_sizer_2->Add(20, 20, 0, 0, 0);
    grid_sizer_2->Add(checkOpenOutput, 0, 0, 0);
    grid_sizer_2->AddGrowableCol(1);
    sizer_58->Add(grid_sizer_2, 0, wxEXPAND, 0);
    sizer_2->Add(sizer_58, 1, wxEXPAND, 0);
    sizer_15->Add(buttonRun, 0, wxALIGN_BOTTOM, 0);
    sizer_15->Add(buttonHide, 0, wxALIGN_BOTTOM, 0);
...
void RemoveOcclusionsDialog::SetInput(ImageFileSet* input)
{
    this->input = input;
}
