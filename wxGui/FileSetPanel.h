...
public:
    ...
    enum {
        BUTTON_ADD_EXAMPLE = wxID_HIGHEST + 1110,
        BUTTON_ADD_SELECTION = wxID_HIGHEST + 1112,
        BUTTON_ADD_PATTERN = wxID_HIGHEST + 1114,
        BUTTON_REMOVE_SELECTION = wxID_HIGHEST + 1116
    };
    // end wxGlade
