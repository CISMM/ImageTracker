...
public:
    ...
    enum {
        CHECK_VISIBILITY = wxID_HIGHEST + 1074,
        SLIDE_WINDOW_MAX = wxID_HIGHEST + 1076,
        SLIDE_WINDOW_MIN = wxID_HIGHEST + 1077,
        COMBO_WINDOW_RANGE = wxID_HIGHEST + 1078,
        BUTTON_AUTO = wxID_HIGHEST + 1080
    };
    // end wxGlade
