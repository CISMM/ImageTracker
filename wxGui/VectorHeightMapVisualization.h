...
/**
 * \class VectorHeightMapVisualization.h
 ...
 */
class VectorHeightMapVisualization :
    public ItkVtkPipeline
{
public:
    // Common itk typedefs
    typedef VectorHeightMapVisualization Self;
    typedef ItkVtkPipeline Superclass;
    typedef itk::SmartPointer< Self > Pointer;
    typedef itk::SmartPointer< const Self > ConstPointer;
    
    itkNewMacro(Self);
    itkTypeMacro(VectorHeightMapVisualization, ItkVtkPipeline);
    ...
    /**
     * Get/Set the visibility of the height map.
     */
    void SetVisibility(int visible);
    int GetVisibility();
    
protected:
    VectorHeightMapVisualization();
    virtual ~VectorHeightMapVisualization();
